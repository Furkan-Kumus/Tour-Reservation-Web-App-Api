...
{
    public class AirportReadRepository : ReadRepository<Airport>, IAirportReadRepository
    {
        public AirportReadRepository(RegisterAPIDbContext context) : base(context)
        {
        }
    }
}
