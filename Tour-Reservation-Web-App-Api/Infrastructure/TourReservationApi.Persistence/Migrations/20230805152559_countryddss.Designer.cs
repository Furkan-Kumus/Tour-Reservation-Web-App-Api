...
namespace TourReservationApi.Persistence.Migrations
{
    ...
    [Migration("20230805152559_countryddss")]
    partial class countryddss
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TourReservationApi.Domain.Entities.Identity.AppRole", b =>
                {
            ...
            modelBuilder.Entity("TourReservationApi.Domain.Entities.Identity.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("TourReservationApi.Domain.Entities.Identity.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TourReservationApi.Domain.Entities.Identity.AppUser", null)
                        .WithMany()
